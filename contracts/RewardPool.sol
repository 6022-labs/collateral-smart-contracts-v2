...
import {RewardPoolLifetimeVault} from "./RewardPoolLifetimeVault.sol";
import {IRewardPool} from "./interfaces/IRewardPool/IRewardPool.sol";
import {IBaseVaultStates} from "./interfaces/IBaseVault/IBaseVaultStates.sol";
import {IControllerRewardPoolActions} from "./interfaces/IController/IControllerRewardPoolActions.sol";
...
contract RewardPool is Ownable, IRewardPool {
    ...
    RewardPoolLifetimeVault public lifetimeVault;
    ...
    function createLifetimeVault(
        ...
        lifetimeVault = new RewardPoolLifetimeVault(
            owner(),
            address(this),
        ...
        onlyWhenLifetimeVaultIsRewardable
    {
        ...
        IControllerRewardPoolActions(controller).pushVault(address(vault));
    ...
    function countRewardableVaults() public view returns (uint256) {
        ...
        for (uint i = 0; i < allVaults.length; i++) {
            IBaseVaultStates vault = IBaseVaultStates(allVaults[i]);
