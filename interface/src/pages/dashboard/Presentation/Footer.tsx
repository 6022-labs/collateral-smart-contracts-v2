...
export default function Footer() {
  ...
  return (
    <div className="w-full flex flex-col gap-y-6 items-center justify-center bg-strong-blue text-white py-4 px-10 sm:flex-row sm:items-stretch sm:gap-y-0 sm:gap-x-12 md:gap-x-32 lg:gap-x-64">
      ...
      <div className="flex flex-col py-2 grow min-h-32 max-w-80 px-4">
