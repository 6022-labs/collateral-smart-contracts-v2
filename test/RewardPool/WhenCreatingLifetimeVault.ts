...
import { RewardPool, MockERC20 } from "../../typechain-types";
...
describe("When creating lifetime vault from reward pool 6022", async function () {
  ...
  async function deployRewardPool() {
    ...
    // Deploy directly a RewardPool instead of using a RewardPoolFactory
    // To be able to test more case (RewardPoolFactory automatically create the lifetime vault...)
